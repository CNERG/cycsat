...
from cycsat.shapes import Circle, Rectangle, Point
...
# from cycsat.geometry import place

# a = gpd.read_file('templates/test.shp')

# a['test'] = a.geometry.apply(lambda x: Shape(stable_wkt=x.wkt))

from cycsat.simulation import Database
import cycsat.archetypes

db = Database('reactor_test_sample.sqlite', cycsat.archetypes)
